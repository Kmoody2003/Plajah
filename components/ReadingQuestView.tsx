...
const GAMES: Game[] = [
  {
    ...
    q: {
      prek: [
        ...
        { prompt: 'Which word ends with the /t/ sound?', options: ['🐶 dog', '🐱 cat', '☀️ sun'], answer: 1 },
        { prompt: 'Which two words rhyme?', options: ['dog & sun', 'hat & cat', 'ball & fish'], answer: 1 },
      ],
      g12: [
        ...
        { prompt: 'Which word has the /ch/ sound?', options: ['care', 'chair', 'share'], answer: 1 },
        { prompt: 'Which word has a silent “e” that makes the vowel say its name?', options: ['kit', 'kite', 'kid'], answer: 1 },
      ],
      g34: [
        ...
        { prompt: 'Which word has the vowel team “ea” as in “beach”?', options: ['bread', 'beach', 'head'], answer: 1 },
        { prompt: 'Add a suffix so “care” means “full of care”:', options: ['careful', 'recare', 'carely'], answer: 0 },
      ],
      g57: [
        ...
        { prompt: 'The root “graph” in “autograph” means:', options: ['write', 'see', 'sound'], answer: 0 },
        { prompt: 'The suffix “-able” in “readable” means:', options: ['before it', 'able to be', 'without it'], answer: 1 },
      ],
    },
  },
  {
    ...
    q: {
      prek: [
        ...
        { prompt: 'Find the fish.', options: ['🐱', '🐟', '🌳'], answer: 1 },
        { prompt: 'Which one do you eat?', options: ['🧦', '🚗', '🍎'], answer: 2 },
      ],
      g12: [
        ...
        { prompt: 'What does “tiny” mean?', options: ['Very big', 'Very small', 'Very fast'], answer: 1 },
        { prompt: 'A “meadow” is a…', options: ['grassy field', 'tall building', 'deep ocean'], answer: 0 },
      ],
      g34: [
        ...
        { prompt: 'Best meaning of “ancient”:', options: ['Very new', 'Very old', 'Very loud'], answer: 1 },
        { prompt: 'If something is “transparent,” you can…', options: ['see through it', 'eat it', 'hear it'], answer: 0 },
      ],
      g57: [
        ...
        { prompt: '“The evidence was irrefutable.” Irrefutable means:', options: ['easy to ignore', 'impossible to deny', 'hard to find'], answer: 1 },
        { prompt: '“She gave a candid answer.” Candid means:', options: ['honest and direct', 'long and boring', 'very quiet'], answer: 0 },
      ],
    },
  },
  {
    ...
    q: {
      prek: [
        ...
        { prompt: 'Who is the story about?', options: ['A dog', 'Sam', 'A car'], answer: 1 },
        { prompt: 'How does Sam feel?', options: ['Happy', 'Sad', 'Sleepy'], answer: 0 },
      ],
      g12: [
        ...
        { prompt: 'What did the frog want to do?', options: ['Climb a tree', 'Cross the pond', 'Find food'], answer: 1 },
        { prompt: 'Which word best describes the frog?', options: ['Determined', 'Lazy', 'Scared'], answer: 0 },
      ],
      g34: [
        ...
        { prompt: 'What was the weather doing?', options: ['Bright and sunny', 'Dark clouds rolling in', 'Snowing'], answer: 1 },
        { prompt: 'How do you know it was about to rain?', options: ['The first drops fell', 'The sun came out', 'It got cold'], answer: 0 },
      ],
      g57: [
        ...
        { prompt: 'Which word best describes Devon?', options: ['Careless', 'Disciplined', 'Forgetful'], answer: 1 },
        { prompt: 'What does “he refused to skip a single evening” show?', options: ['His commitment', 'His boredom', 'His fear'], answer: 0 },
      ],
    },
  },
];
