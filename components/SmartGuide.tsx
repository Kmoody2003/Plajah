...
const TEXT_TIPS: Record<string, Tip> = {
  ...
  "plajah labs":        { icon: "🔬", label: "Plajah Musecion", desc: "Science, engineering, and academia hub — research tools, living museum disciplines, and peer discussion for curious minds." },
