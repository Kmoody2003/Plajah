...
const MusicView: React.FC<MusicViewProps> = ({ onBack, onSelectAlbum, onVisitUser, userProfile }) => {
      ...
      <div className="flex flex-col h-full">
        <div className="flex-1 min-w-0">
          ...
          {activeTab === 'NEW' && !selectedArchiveArtist && (
            <div className="px-6 lg:px-12 pt-8 mb-6 grid grid-cols-1 lg:grid-cols-3 gap-8">
