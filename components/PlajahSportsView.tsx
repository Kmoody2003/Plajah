...
const SPORT_REQUIRED_TERMS: Record<string, string[]> = {
  ...
  FIFA:      ['world cup','fifa world cup','world cup 2026','usmnt','national team','usa soccer','mexico soccer','canada soccer','group stage','knockout stage','messi','mbappe','christian pulisic','soccer','goal scorer','goalkeeper','striker','corner kick','penalty kick','offside','header','dribble','qualifier','concacaf','uefa','conmebol'],
