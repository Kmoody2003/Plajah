...
export const LESSON_TEMPLATES: LessonTemplate[] = [
  ...
  { id: 'field-lab', label: 'Field Lab', kicker: 'Observe → test → build', description: '3D specimens, simulations, notebook prompts and a creation checkpoint.', bestFor: 'science, engineering, archaeology', accent: '#06D6A0', gradient: 'linear-gradient(135deg,#103a42,#06D6A0)', signature: 'Plajah Labs tools live inside the lesson.' },
...
export const LESSON_STUDIO_SOURCES: RichLessonSource[] = [
  ...
  { id: 'src-map', kind: 'dataset', provider: 'plajah-labs', title: 'Detroit population & migration, 1910–1970', excerpt: 'Decennial population series prepared for classroom visualization.', license: 'PD', attribution: 'U.S. Census historical tables; visualization by Plajah Labs', quotationReady: true, accent: '#06D6A0' },
  ...
  { id: 'src-model', kind: 'model3d', provider: 'plajah-labs', title: 'Motown Studio A spatial model', excerpt: 'A reconstructed 3D room for exploring how space shaped a recorded sound.', license: 'teacher-owned', attribution: 'Plajah Labs educational reconstruction', quotationReady: false, accent: '#6B0099' },
];
...
export function buildSeededRichLesson(templateId: LessonTemplateId = 'cinematic'): RichLessonDraft {
  return {
    ...
    blocks: [
      ...
      { id: 'b4', kind: 'model3d', title: 'Step inside the sound', body: 'Rotate the Motown Studio A model, place musicians, and test how room position changes the listening focus.', minutes: 9, sourceIds: ['src-model','src-song'], mediaCue: 'Plajah Labs 3D viewer with spatial-audio hotspots.', teacherMove: 'Connect a production choice to an audience effect.', checkFor: 'Causal language grounded in the model.' },
