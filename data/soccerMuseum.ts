...
export interface IconicMoment {
  ...
  youtube: string;      // search query for the highlight
...
export const ICONIC_MOMENTS: IconicMoment[] = [
  { id: 'hand-of-god', title: 'The Hand of God & Goal of the Century', year: 1986, who: 'Diego Maradona', tag: 'Goal',
  ...
  { id: 'maracanazo', title: 'The Maracanazo', year: 1950, who: 'Uruguay', tag: 'Upset',
  ...
  { id: 'zidane-headbutt', title: 'The Headbutt', year: 2006, who: 'Zinedine Zidane', tag: 'Drama',
  ...
  { id: 'iniesta-2010', title: 'Iniesta Wins It for Spain', year: 2010, who: 'Andrés Iniesta', tag: 'Goal',
  ...
  { id: 'gotze-2014', title: 'Götze\'s Golden Touch', year: 2014, who: 'Mario Götze', tag: 'Goal',
  ...
  { id: 'mbappe-2022', title: 'A Final for the Ages', year: 2022, who: 'Messi & Mbappé', tag: 'Drama',
  ...
  { id: 'banks-save', title: 'The Save of the Century', year: 1970, who: 'Gordon Banks', tag: 'Save',
  ...
  { id: 'carlos-freekick', title: 'The Impossible Free Kick', year: 1997, who: 'Roberto Carlos', tag: 'Goal',
  ...
  { id: 'milla-dance', title: 'Roger Milla\'s Corner-Flag Dance', year: 1990, who: 'Roger Milla', tag: 'Moment',
  ...
  { id: 'baggio-miss', title: 'Baggio\'s Penalty', year: 1994, who: 'Roberto Baggio', tag: 'Drama',
  ...
  { id: 'korea-2002', title: 'Korea\'s Miracle Run', year: 2002, who: 'South Korea', tag: 'Upset',
  ...
  { id: 'morocco-2022', title: 'Morocco Makes History', year: 2022, who: 'Morocco', tag: 'Upset',
  ...
  { id: 'germany-brazil', title: 'The 7–1', year: 2014, who: 'Germany vs Brazil', tag: 'Drama',
  ...
  { id: 'usa-1950', title: 'The Miracle on Grass', year: 1950, who: 'United States', tag: 'Upset',
