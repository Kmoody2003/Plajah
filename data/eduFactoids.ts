...
export const EDU_FACTOIDS: EduFactoid[] = [
  ...
  { id: 'f_art1', subject: 'Art', emoji: '🖼️', text: 'Van Gogh sold only ONE painting while he was alive. Today a single one can sell for over $80 million.', source: 'Plajah Labs · Art Masters' },
  ...
  { id: 'f_hist1', subject: 'History', emoji: '🏛️', text: 'The Library of Alexandria didn\'t burn down all at once — it declined slowly over centuries as funding dried up.', source: 'Plajah Labs · World History' },
  { id: 'f_hist2', subject: 'History', emoji: '🗺️', text: 'The Great Wall of China isn\'t one wall — it\'s many walls built by different dynasties over 2,000 years.', source: 'Plajah Labs · World History' },
  { id: 'f_sci1', subject: 'Science', emoji: '🔬', text: 'A teaspoon of neutron-star material would weigh about 6 billion tons on Earth.', source: 'Plajah Labs · Astronomy' },
  { id: 'f_sci2', subject: 'Science', emoji: '🧬', text: 'You share about 60% of your DNA with a banana — the basic machinery of life is that old and shared.', source: 'Plajah Labs · Biology' },
  ...
  { id: 'f_arch1', subject: 'Architecture', emoji: '🏗️', text: 'Ancient Roman concrete is still standing after 2,000 years — and it actually gets STRONGER with seawater.', source: 'Plajah Labs · Architecture' },
  ...
  { id: 'f_arch2', subject: 'Archaeology', emoji: '🏺', text: 'The Rosetta Stone cracked ancient Egyptian by repeating the same text in three scripts — a 2,000-year-old cheat sheet.', source: 'Plajah Labs · Archaeology' },
];
