...
class ErrorBlock extends React.Component<ErrorBlockProps, ErrorBlockState> {
              ...
              <div className="flex flex-col lg:flex-row w-full h-full">
                <div className="flex-1 p-6 lg:p-16 max-w-7xl mx-auto w-full">
                  <header className="mb-12 flex flex-col lg:flex-row lg:items-end lg:justify-between gap-8">
                    <div>
                      <div className="flex flex-col xl:flex-row xl:items-center gap-8 mb-4">
                        ...
                        <button 
                          onClick={() => {
                            ...
                            if (archiveTab === 'VIDEO') defaultType = 'VIDEO';
                            else if (archiveTab === 'BOOK') defaultType = 'BOOK';
                            setEditingAlbum({ type: defaultType } as any);
                            setShowCreator(true);
                          }}
                          className="group relative flex items-center gap-4 bg-gradient-to-r from-small-orange to-orange-600 p-2 pr-6 md:pr-8 rounded-full hover:scale-105 transition-all duration-500 shadow-[0_0_40px_rgba(255,140,0,0.4)] hover:shadow-[0_0_80px_rgba(255,140,0,0.8)] self-start xl:self-auto"
                        >
                          <div className="absolute inset-0 rounded-full bg-small-orange animate-ping opacity-25"></div>
                          <div className="w-12 h-12 md:w-20 md:h-20 bg-white rounded-full flex items-center justify-center relative z-10 group-hover:rotate-90 transition-transform duration-500">
                            <span className="text-3xl md:text-6xl text-black font-light leading-none mb-1 md:mb-2">+</span>
                          </div>
                          <span className="text-[10px] md:text-sm font-black uppercase tracking-[0.2em] text-white relative z-10 whitespace-nowrap">Creators Upload Here</span>
                        </button>
                      </div>
