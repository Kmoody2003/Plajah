...
const BASE_ACHIEVEMENTS: Omit<Achievement, 'id' | 'createdAt' | 'updatedAt'>[] = [
  ...
  // ACADEMIA — gamified learning achievements
  {
    title: 'First Steps',
    description: 'Started your first math session',
    category: 'USER',
    triggerType: 'MATH_FIRST_SESSION',
    icon: 'Sparkles',
    backgroundColor: '#8166e6',
    pointsValue: 15,
    requirements: { type: 'ACTION', actionTrigger: 'MATH_FIRST_SESSION' },
    rewards: { pointsBonus: 15 },
    createdBy: 'SYSTEM',
    isActive: true,
  },
  {
    title: '10-Streak Blazer',
    description: 'Answered 10 math problems correctly in a row',
    category: 'USER',
    triggerType: 'MATH_STREAK_10',
    icon: 'Flame',
    backgroundColor: '#FF8C00',
    pointsValue: 40,
    requirements: { type: 'ACTION', actionTrigger: 'MATH_STREAK_10' },
    rewards: { pointsBonus: 40 },
    createdBy: 'SYSTEM',
    isActive: true,
  },
  {
    title: 'Century',
    description: 'Scored 100+ in a Time Attack run',
    category: 'USER',
    triggerType: 'MATH_TIME_ATTACK_100',
    icon: 'Zap',
    backgroundColor: '#36c5f0',
    pointsValue: 30,
    requirements: { type: 'ACTION', actionTrigger: 'MATH_TIME_ATTACK_100' },
    rewards: { pointsBonus: 30 },
    createdBy: 'SYSTEM',
    isActive: true,
  },
  {
    title: 'Homework Done',
    description: 'Turned in your first digital assignment',
    category: 'USER',
    triggerType: 'WORKSHEET_TURNED_IN',
    icon: 'ClipboardCheck',
    backgroundColor: '#2bd67a',
    pointsValue: 20,
    requirements: { type: 'ACTION', actionTrigger: 'WORKSHEET_TURNED_IN' },
    rewards: { pointsBonus: 20 },
    createdBy: 'SYSTEM',
    isActive: true,
  },
  {
    title: 'Perfect Score',
    description: 'Got 100% on a turned-in assignment',
    category: 'USER',
    triggerType: 'WORKSHEET_PERFECT',
    icon: 'Trophy',
    backgroundColor: '#FFD24A',
    pointsValue: 50,
    requirements: { type: 'ACTION', actionTrigger: 'WORKSHEET_PERFECT' },
    rewards: { pointsBonus: 50 },
    createdBy: 'SYSTEM',
    isActive: true,
  },
